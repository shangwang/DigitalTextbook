...
-(void)uploadCMapImg
{
    ...
    UIGraphicsBeginImageContext(conceptMapView.contentSize);
    {
       ...
       // [conceptMapView.layer renderInContext: UIGraphicsGetCurrentContext()];
        ...
        [conceptMapView drawViewHierarchyInRect:CGRectMake(0, 0, conceptMapView.contentSize.width, conceptMapView.contentSize.height) afterScreenUpdates:YES];
    ...
    */
       ...
       UIGraphicsBeginImageContext(conceptMapView.contentSize);
     //UIGraphicsBeginImageContextWithOptions(conceptMapView.contentSize, NO, [UIScreen mainScreen].scale);
    ...
    conceptMapView.contentOffset = CGPointZero;
    conceptMapView.frame = CGRectMake(0, 0, conceptMapView.contentSize.width, conceptMapView.contentSize.height);
    conceptMapView.backgroundColor=[UIColor whiteColor];
